...
Usage:
  python Ninth_drift.py --calibrate                           # auto threshold
  python Ninth_drift.py --input my.mp4 --frames 99999 --calibrate --l2_scale 1.0
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="Ninth_drift_output.mp4", help="Output video path")
